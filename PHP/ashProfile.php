...
<div class="mainColumn">
    <div class="columnOne">
        <div class="animalAttr">
            <img src="../Resources/backgAsh.svg">
            <p class="name">Ash</p>
            <p class="details">Beagle</p>
            <p class="details">Female</p>
            <p class="details">Tangerang</p>
            <a href="#"><p>Adopt</p></a>
        </div>
    </div>
    ...
    <div class="columnTwo">
        <div class="bodyMarkings">
            ...
            <div class="bodyMdetails">
                <div class="left">
                    <p class="details"> Coat color: Black, White, Brown</p>
                    <p class="details"> Fur type: &nbsp;&nbsp;&nbsp;&nbsp; Smooth and Dense</p>
                </div>
        ...
        <div class="medical">
            ...
            <div class="medicalDetails">
                ...
                <div class="right">
                    <p class="details">Allergies: &nbsp;&nbsp;&nbsp;Corn</p>
