...
<div class="mainColumn">
    <div class="columnOne">
        <div class="animalAttr">
            <img src="../Resources/backgTim.svg">
            <p class="name">Tim</p>
            <p class="details">Russian Blue</p>
    ...
    <div class="columnTwo">
        <div class="bodyMarkings">
            ...
            <div class="bodyMdetails">
                <div class="left">
                    <p class="details"> Coat color: Bluish gray</p>
                    <p class="details"> Fur type: &nbsp;&nbsp;&nbsp;&nbsp; Very dense</p>
                </div>

                <div class="right">
                    <p class="details">Height: &nbsp;20 cm</p>
                    <p class="details">Weight: 5 kg</p>
                </div>
            </div>
        </div>
