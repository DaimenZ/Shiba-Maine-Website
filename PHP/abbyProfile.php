...
<div class="mainColumn">
    <div class="columnOne">
        <div class="animalAttr">
            <img src="../Resources/backgAbby.svg">
            <p class="name">Abby</p>
            <p class="details">Siamese</p>
    ...
    <div class="columnTwo">
        <div class="bodyMarkings">
            ...
            <div class="bodyMdetails">
                <div class="left">
                    <p class="details"> Coat color: Seal point</p>
                    <p class="details"> Fur type: &nbsp;&nbsp;&nbsp;&nbsp; Sleek</p>
                </div>

                <div class="right">
                    <p class="details">Height: &nbsp;29 cm</p>
                    <p class="details">Weight: 6 kg</p>
                </div>
            </div>
        </div>
