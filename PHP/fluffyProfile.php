...
<head>
    ...
    <title>Dog Profile - Fluffy</title>
...
<div class="mainColumn">
    <div class="columnOne">
        <div class="animalAttr">
            <img src="../Resources/backgFluffy.svg">
            <p class="name">Fluffy</p>
            <p class="details">Golden Retriever</p>
            <p class="details">Female</p>
            <p class="details">Bekasi</p>
            <a href="#"><p>Adopt</p></a>
        </div>
    </div>
    ...
    <div class="columnTwo">
        <div class="bodyMarkings">
            ...
            <div class="bodyMdetails">
                <div class="left">
                    <p class="details"> Coat color: Black</p>
                    <p class="details"> Fur type: &nbsp;&nbsp;&nbsp;&nbsp; Long and Dense</p>
                </div>

                <div class="right">
                    <p class="details">Height: &nbsp;51 cm</p>
                    <p class="details">Weight: 25 kg</p>
                </div>
            </div>
        </div>
