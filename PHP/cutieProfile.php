...
<div class="mainColumn">
    <div class="columnOne">
        <div class="animalAttr">
            <img src="../Resources/backgCutie.svg">
            <p class="name">Cutie</p>
            <p class="details">Bombay</p>
        ...
        <div class="bodyMarkings">
            ...
            <div class="bodyMdetails">
                <div class="left">
                    ...
                    <p class="details"> Fur type: &nbsp;&nbsp;&nbsp;&nbsp; Short and Sleek</p>
                </div>

                <div class="right">
                    <p class="details">Height: &nbsp;25 cm</p>
